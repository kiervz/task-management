        ...
        <table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0" style="max-width:560px;background-color:#ffffff;border-radius:16px;">
          <tr>
            <td style="background-color:#0f0f0f;padding:30px 38px;border-radius:16px 16px 0 0;">
              <p style="margin:0;font-family:Arial,sans-serif;font-size:11px;font-weight:bold;letter-spacing:3px;text-transform:uppercase;color:#888888;">Email Verification</p>
              <h1 style="margin:12px 0 0;font-family:Georgia,'Times New Roman',serif;font-size:30px;font-weight:normal;color:#ffffff;line-height:1.2;">Verify your account</h1>
            </td>
          </tr>
          <tr>
            <td style="padding:30px 38px 14px;">
              <p style="margin:0;font-family:Arial,sans-serif;font-size:15px;color:#666666;line-height:1.7;">
                Hi <strong style="color:#0f0f0f;">{{ $name }}</strong>, use the code below to verify your email address.
          ...
          <tr>
            <td style="padding:18px 38px 6px;">
              <p style="margin:0;font-family:Arial,sans-serif;font-size:11px;font-weight:bold;letter-spacing:2px;text-transform:uppercase;color:#aaaaaa;">Your verification code</p>
            </td>
          </tr>
          <tr>
          ...
          <tr>
            <td style="background-color:#f7f5f2;padding:10px 38px;border-radius:0 0 16px 16px;border-top:1px solid #ede9e4;">
              <p style="margin:0;font-family:Arial,sans-serif;font-size:12px;color:#aaaaaa;line-height:1.6;">If you didn't create an account, you can safely ignore this email.</p>
            </td>
          </tr>
        </table>
      </td>
